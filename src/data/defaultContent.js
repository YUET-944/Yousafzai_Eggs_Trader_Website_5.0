export const defaultContent = {
  hero: {
    ...
    h1Line2: 'Built on',
    body: 'Yousafzai Eggs Traders is a leading supplier and distributor of high-quality fresh eggs in KPK, Pakistan. We deliver hygienic, farm-fresh eggs with consistent quality and reliable service.',
  ...
  eggTraders: {
    company: {
      name: 'Egg Traders',
      sub: 'Poultry Trading',
      tagline: 'A Yousafzai Eggs Traders company connecting verified poultry farms with commercial buyers through a clear supply process.',
    },
    hero: {
      eyebrow: '',
      backgroundImage: '',
    ...
    about: {
      ...
      paragraphs: [
        'Founded as a Yousafzai Eggs Traders venture, Egg Traders was built to connect verified farms directly with commercial buyers.',
